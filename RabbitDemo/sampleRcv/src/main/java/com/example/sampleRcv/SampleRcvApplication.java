...
import com.example.sampleRcv.listener.MsgListener;


@SpringBootApplication
public class SampleRcvApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(SampleRcvApplication.class, args);
	}
}
